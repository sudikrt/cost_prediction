...
$from_email = 'geekyint@gmail.com'; //Webmaster email
...
$smtp_user = 'geekyint@gmail.com';
$smtp_pw = '12553255';
$smtp_port = 465; //465 for ssl, 587 for tls, 25 for other
$smtp_security = 'ssl';//ssl, tls or ''

//HTML Messages shown before URL in emails (the more
$verifymsg = 'Click this link to verify your new account! You may now login at <br><a href="'.$signin_url.'">'.$signin_url.'</a>'; //Verify email message
$active_email = 'Your new account is now active! Click this link to log in!';//Active email message
//LOGIN FORM RESPONSE MESSAGES/ERRORS
$signupthanks = 'Thank you for signing up! You may now login at <br><a href="'.$signin_url.'">'.$signin_url.'</a>';
