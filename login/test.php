        ...
        searchBox.addListener('places_changed', function() {
          ...
          places.forEach(function(place) {
            ...
            markers.push(new google.maps.Marker({
              ...
              document.getElementById('latitude').value=place.geometry.location.lat().toFixed(8); //event.lat();
            document.getElementById('longitude').value=place.geometry.location.lng().toFixed(8);
